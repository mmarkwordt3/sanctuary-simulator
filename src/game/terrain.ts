 ...
 * unladen Bearer already inside may only move onto G7 to collect the flag) is
 * enforced in movement generation, and laden Bearers move freely during
 * extraction (rule 5). See README "Inner-circle occupancy".
 */
