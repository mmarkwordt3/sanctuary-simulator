...
async function refreshBaselineDropdown(selectProfileId?: string): Promise<void> {
  ...
  const approved = await tuningStore.listApprovedExperimentalProfiles();
