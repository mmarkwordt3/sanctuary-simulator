...
export const PIECE_SUMMARY: Record<PieceType, string> = {
  flagBearer:
    "Moves 1–2 (1 while laden). Enters the Sanctuary only when the flag is at G7 and it is empty; once inside (unladen) it may only move to G7 to collect the flag.",
  engineer:
